...
const templateEmail = (messageTemplate: any) => {
  return `<!DOCTYPE html
                                            ...
                                            <div
                                                ...
                                                <div class="txtTinyMce-wrapper"
                                                    ...
                                                    <p
                                                        ...
                                                        <span
                                                            style="font-size: 30px; color: #2b303a;"><strong>${messageTemplate.title}</strong></span>
                                                    </p>
                                                </div>
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
                                            ...
                                            <div
                                                ...
                                                <div class="txtTinyMce-wrapper"
                                                    ...
                                                    <p
                                                        ...
                                                        <span
                                                            style="color: #808389; font-size: 15px;">${messageTemplate.description}</span>
                                                    </p>
                                                </div>
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
                                            ${messageTemplate.displayButton? `
                                            <div align="center" class="button-container"
                                                style="padding-top:15px;padding-right:10px;padding-bottom:0px;padding-left:10px;">
                                                <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-top: 15px; padding-right: 10px; padding-bottom: 0px; padding-left: 10px" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:46.5pt;width:146.25pt;v-text-anchor:middle;" arcsize="97%" stroke="false" fillcolor="#ffc107"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#ffffff; font-family:Tahoma, sans-serif; font-size:16px"><![endif]-->
                                                <a href="${messageTemplate.buttonLink}">
                                                <div
                                                    style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#ffc107;border-radius:60px;-webkit-border-radius:60px;-moz-border-radius:60px;width:auto; width:auto;;border-top:1px solid #ffc107;border-right:1px solid #ffc107;border-bottom:1px solid #ffc107;border-left:1px solid #ffc107;padding-top:15px;padding-bottom:15px;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;">
                                                    <span
                                                        style="padding-left:30px;padding-right:30px;font-size:16px;display:inline-block;letter-spacing:undefined;"><span
                                                            style="font-size: 16px; margin: 0; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;"><strong>${messageTemplate.buttonText}</strong></span></span>
                                                </div>
                                                </a>
...
export const pendingInterviewTemplate = (interviewerName: string, interviewDate: string, token: string) => {
  const messageTemplate = {
    title: "Confirm your interview",
    description: `You have scheduled an interview with ${interviewerName} on ${interviewDate} please confirm to take into effect.`,
    displayButton: true,
    buttonText: "Confirm Interview",
    buttonLink: `${config.urlApp}/confirmInterview/${token}`,
  };
  return templateEmail(messageTemplate);
}

export const interviewConfirmedTemplate = (name: string, interviewDate: string, token: string) => {
  const messageTemplate = {
    title: "Interview confirmed",
    description: `The interview with ${name} on ${interviewDate} has been confirmed. If you can't assist please cancel.`,
    displayButton: true,
    buttonText: "Cancel Interview",
    buttonLink: `${config.urlApp}/cancelInterview/${token}`,
  };
  return templateEmail(messageTemplate);
}

export const interviewCanceledTemplate = (name: string, interviewDate: string) => {
  const messageTemplate = {
    title: "Interview canceled!",
    description: `The interview with ${name} on ${interviewDate} has been cancelled.`,
    displayButton: false
  };
  return templateEmail(messageTemplate);
}